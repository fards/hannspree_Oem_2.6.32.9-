...
/* =============================================================== */
#define MXT_SET_ADDRESS  ('x' + 1)  /* Sets the internal address pointer */
#define MXT_RESET       ('x' + 2)  /* Resets the device */
#define MXT_CALIBRATE   ('x' + 3)  /* Calibrates the device */
#define MXT_BACKUP      ('x' + 4)  /* Backups the current state of registers to */
#define MXT_NONTOUCH_MSG ('x' + 5)  /* Only non-touch messages can be read from
                                  the message buffer (/dev/maXTouch_messages)*/
#define MXT_ALL_MSG ('x' + 6)  /* All messages can be read from the message*/
/* =============================================================== */
